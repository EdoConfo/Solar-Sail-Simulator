...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=0.7\textwidth]{Images/orbital_trail.png}
...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=0.6\textwidth]{Images/raycasting_debug.png}
...
\begin{figure}[htbp!]
    \centering
    \includegraphics[width=0.7\textwidth]{Images/live_telemetry.png}
