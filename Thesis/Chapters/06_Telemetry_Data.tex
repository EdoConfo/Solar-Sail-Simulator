...
Per ogni vela individuata nella scena, l'algoritmo assembla un blocco di stringhe che funziona come vero e proprio pannello di controllo in cui i dati spaziali (Velocità, Distanza, Forza Solare e Area) vengono formattati e impaginati a colonna. 
...
Per il grafico risultante, lo script impiega \lstinline|matplotlib| per generare due grafici impilati verticalmente: il primo dedicato alla distanza radiale e il secondo alla velocità orbitale, entrambi in funzione del tempo:
