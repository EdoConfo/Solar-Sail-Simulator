...
Difatti il Sole si comporta come una enorme lampada sferica che irradia energia in tutte le direzioni. La potenza totale emessa dal Sole è una costante fisica, espressa in $W$ che può essere calcolata a partire dalla Costante Solare e dall'area della sfera di raggio 1 AU:
...
Oltre a questo la vela può presentare deformazioni strutturali, pieghe o irregolarità che causano ulteriori ombre.

Per calcolare con precisione l'area effettivamente illuminata, l'equazione algebrica $A_{\text{eff}} = A \cos(\alpha)$ non basta.
Il calcolo deve essere impostato come un integrale di superficie che includa una funzione di visibilità $v(x,y)$, la quale restituisce valore $1$ se il punto è direttamente illuminato e $0$ se è in ombra:
...
Dal punto di vista della meccanica dei corpi rigidi, la differenza di pressione causata dalla radiazione solare, fra l'ombra e la superficie illuminata, dà luogo ad una discordanza tra i due centri di pressione fotonica e di massa del veicolo che genera un momento torcente che provoca la rotazione del veicolo.
...
\begin{itemize}
    ...
    \item $m$ è la massa del veicolo spaziale, che subisce l'attrazione gravità generata dal corpo centrale;
