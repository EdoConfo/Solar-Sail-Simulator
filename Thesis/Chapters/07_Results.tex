...
\begin{enumerate}
    ...
    \item \textbf{Validazione delle Eclissi:} La conferma dell'azzeramento istantaneo della forza propulsiva durante i periodi di eclissi, quando la sonda si trova all'interno del cono d'ombra terrestre.
\end{enumerate}
