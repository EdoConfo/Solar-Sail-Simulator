...
// Enum per il tipo di orbita iniziale
UENUM(BlueprintType)
...
// Enum per il coefficiente di riflettività
UENUM(BlueprintType)
...
public:
    ...
    // Parametri della velocità iniziale
    ...
    // Parametri di gravità terrestre
...
private:
    UPROPERTY() ASimulationManager* Manager; // Dichiarato come UPROPERTY per la gestione della memoria da parte di UE
